...
<html lang="en">
	<head>
		...
		<!-- stylesheets -->
		<link href="http://localhost/painless/beauty/tempor/php/samples/assets/bootstrap.min.css" rel="stylesheet">
		<link href="http://localhost/painless/beauty/tempor/php/samples/assets/font-awesome/css/font-awesome.min.css" rel="stylesheet">
		<link href="http://localhost/painless/beauty/tempor/php/samples/assets/style.css" rel="stylesheet">
		
		<!-- scripts -->
		<script src="http://localhost/painless/beauty/tempor/php/samples/assets/js/jquery-3.1.0.min.js"></script>
		<script src="http://localhost/painless/beauty/tempor/php/samples/assets/js/bootstrap.min.js"></script>
